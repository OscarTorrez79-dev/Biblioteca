...
<head>
  <meta http-equiv="content-type" content="text/html; charset=UTF-8">
    ...
    <title>Biblioteca de Peña</title>
      ...
      <div class="abs-center">
        <form action="validar.php" onsubmit="return buscar()" method="post" class="border p-3 form">
          ...
          <div class="float-right">
            <small class="small-text-login">¿Olvidaste tu contraseña? <a class="lost-password" href="restablecer.php">Restablecerla aquí</a></small>
          </div>
          <div>
            <button type="submit" class="btn-success-login">Ingresar</button>
          </div>
          <div class="text-white" style="margin-top: 30px;">
            <a class="lost-password" href="crear_cuenta.php">Crear cuenta nueva</a>
          </div>
        </form>
      </div>
    </div>
